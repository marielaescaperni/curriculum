import type { SecondaryProject } from '$lib/types/project';

export const secondaryProjects: SecondaryProject[] = [
	{
		slug: 'lot-vault',
		title: 'Lot Vault — Cecilian Partners',
		role: 'UX/UI Designer',
		period: '2024 — 2025',
		description:
		...
		highlight:
			'Worked across workflows, reusable interface patterns and developer collaboration for a production SaaS product.',
		tags: ['SaaS', 'Product Design', 'UX/UI', 'Complex Workflows'],
